...
public abstract class Server
{
    ...
    */
    public class ServerConnection extends Connection
    {
        ...
        */
        ...
        public void setKey1(int k)
        {
            k1 = k;
        }
        
        public void setKey2(int k)
        {
            k2 = k;
        }
    ...
    */
    ...
    {
        startKeyExchange(pClientIP, pClientPort);
        //sendToAll(pClientIP.substring(1, pClientIP.length()) + ":" + pClientPort + " is now online");
        //send(pClientIP, pClientPort, "Hallo " + pClientIP.substring(1, pClientIP.length()));
    }
    
    private void startKeyExchange(String IP, int port)
    {
       Random ran = new SecureRandom(); 
       ServerConnection con = SerververbindungVonIPUndPort(IP, port);
       
       int p = BigInteger.probablePrime(16, ran).intValue();
       int g = 0;
       System.out.println("p: " + p);
       
       con.send(String.valueOf(p));
       ...
       int a = BigInteger.probablePrime(16, ran).intValue();
                    
       while(!(a > 1 && a < p-1))
        a = BigInteger.probablePrime(16, ran).intValue();
                    
       System.out.println("a: " + a);
       
       int A = (int)Math.pow(g, a) % p;
       
       con.send(String.valueOf(A));
       ...
       while(new String(new char[K]).matches(".?|(..+?)\\1+"))
           K++;
       
       System.out.println("K: " + K);
       
       SerververbindungVonIPUndPort(IP, port).setKey1(K);
       
       p = BigInteger.probablePrime(16, ran).intValue();
       g = 0;
       System.out.println("p: " + p);
       ...
       while(new String(new char[K]).matches(".?|(..+?)\\1+"))
           K++;
       SerververbindungVonIPUndPort(IP, port).setKey2(K);
    ...
    */
    ...
    {
        sendToAll(pClientIP.substring(1, pClientIP.length()) + ":" + pClientPort + " is now offline");
    }
    ...
    */
    ...
    public void printList()
    {
        ...
        {
            lSerververbindung = (ServerConnection) verbindungen.getObject();
            System.out.println("IP: " + lSerververbindung.getRemoteIP() + " Port: " + lSerververbindung.getRemotePort());
            verbindungen.next();
        }
    }
